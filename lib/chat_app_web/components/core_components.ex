defmodule ChatAppWeb.CoreComponents do
  ...
  def flash(assigns) do
    ...
    >
      <p :if={@title} class="flex items-center gap-1.5 text-sm font-semibold leading-6">
        <.icon :if={@kind == :info} name={:information_circle} outlined class="h-4 w-4" />
        <.icon :if={@kind == :error} name={:exclamation_circle} outlined class="h-4 w-4" />
        <%= @title %>
      </p>
      <p class="mt-2 text-sm leading-5"><%= msg %></p>
      <button type="button" class="group absolute top-1 right-1 p-2" aria-label={gettext("close")}>
        <.icon name={:x_mark} solid class="h-4 w-4" />
      </button>
    </div>
    """
  end
  ...
  def flash_group(assigns) do
    ...
    <.flash
      ...
      hidden
    >
      Attempting to reconnect <.icon name={:arrow_path} outlined class="ml-1 h-3 w-3 animate-spin" />
    </.flash>
    ...
    >
      ...
      <.icon name={:arrow_path} outlined class="ml-1 h-3 w-3 animate-spin" />
    </.flash>
    """
  end
  ...
  def back(assigns) do
    ...
    <div class="mt-16">
      ...
      >
        <.icon name={:arrow_left} solid class="h-3 w-3" />
        <%= render_slot(@inner_block) %>
      </.link>
    </div>
    """
  ...
  Copy from: LiveBeat (https://github.com/fly-apps/live_beats/blob/master/lib/live_beats_web/components/core_components.ex)
  See: https://github.com/mveytsman/heroicons_elixir
